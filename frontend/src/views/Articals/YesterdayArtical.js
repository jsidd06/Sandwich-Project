...
function YesterdayArticles() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "https://newsapi.org/v2/everything?q=apple&from=2022-02-17&to=2022-02-17&sortBy=popularity&apiKey=166ff5e1c97a400fbbcb588ed6cc9d3e"
      )
      .then((res) => {
...
export default YesterdayArticles;
