...
function BusinessArticals() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=166ff5e1c97a400fbbcb588ed6cc9d3e"
      )
      .then((res) => {
...
export default BusinessArticals;
